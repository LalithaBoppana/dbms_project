...
export const Auth = ({ type }: { type: "signup" | "signin" }) => {
    ...
    const [postInputs, setPostInputs] = useState<Object>({
        name: "",
        username: "",
        password: ""
    });
    ...
    return <div>
      <Header signin={true} signup={true} myaccount={false}/>
    ...
    <div className=" flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="First Name" placeholder="Enter  First Name" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                    {type === "signup" ? <LabelledInput label="Last Name" placeholder="Enter  Last Name" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                        {type === "signup" ? <LabelledInput label="Phone Number" placeholder="Enter phone number" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                        {type === "signup" ? <LabelledInput label="Address" placeholder="Enter Address" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
